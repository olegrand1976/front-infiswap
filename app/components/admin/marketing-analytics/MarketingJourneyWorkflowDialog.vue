<template>
    <Dialog :open="open" @update:open="onOpenChange">
        <DialogContent class="w-[calc(100vw-1.5rem)] max-w-4xl max-h-[90vh] overflow-hidden flex flex-col gap-3 p-4 sm:p-6">
            <div data-testid="journey-workflow-dialog" class="contents">
            <DialogHeader>
                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-gray-50 text-left text-xs uppercase tracking-wide text-gray-500">
                                <tr>
                                    ...
                                    <th class="px-3 py-2 font-medium">Envoyé</th>
                                    <th class="px-3 py-2 font-medium">Ouvert</th>
                                    <th class="px-3 py-2 font-medium">Clic</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                ...
                                >
                                    ...
                                    <td class="px-3 py-2 text-gray-600">{{ row.step ?? '—' }}</td>
                                    <td class="px-3 py-2 text-gray-600 whitespace-nowrap">{{ formatDateTime(row.sent_at) }}</td>
