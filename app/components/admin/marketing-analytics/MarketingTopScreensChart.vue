<template>
    <div class="px-4 pb-4">
        ...
        <div
            ...
            class="rounded-md border border-dashed border-gray-200 bg-white p-6 text-sm text-gray-500"
        >
            Aucune page vue enregistrée sur la période. Les données apparaîtront après navigation des utilisateurs connectés.
        </div>
        <ClientOnly v-else>
            <BarChart
                :data="chartData"
