...
const CONTENT_BY_COUNTRY: Record<OffreInstitutionCountry, OffreInstitutionCountryContent> = {
    be: {
        ...
        insightTitle: 'Le partenariat InfiSwap × Jaumana Soins',
        insightParagraph:
            'En nous appuyant sur un <strong>réseau d\'infirmières indépendantes</strong>, nous éliminons les intermédiaires gourmands. Vous publiez en autonomie sur InfiSwap (DIY à {diyMonthlyLabel}) ou vous sécurisez vos remplacements via la <strong>convention Jaumana</strong> : publication sur InfiSwap, paiements garantis, engagements des titulaires et protection contre le détournement de patientèle.',
        ...
        footerCopyright: 'Partenariat officiel InfiSwap × Jaumana Soins — vos soins sans interruption.',
    },
    fr: {
        ...
        trustBannerMembers: `Plus de ${formatOffreInstitutionNetworkCount()} infirmières qualifiées inscrites`,
        heroDescription:
            'Marre de payer l\'intérim à <strong>100 € / heure</strong> ? Découvrez la puissance de frappe d\'InfiSwap, fort de <strong>{networkMembers}</strong>. Publiez vos besoins sur la plateforme et trouvez vos remplaçants en autonomie.',
        institutionContextLead:
        ...
        insightTitle: 'La plateforme InfiSwap pour votre établissement',
        insightParagraph:
            'En nous appuyant sur un <strong>réseau d\'infirmières indépendantes</strong>, nous éliminons les intermédiaires gourmands. Publiez en autonomie sur InfiSwap (DIY à {diyMonthlyLabel}) et mobilisez rapidement des profils qualifiés pour assurer la continuité de vos soins.',
        ...
        footerCopyright: 'Vos soins sans interruption.',
    },
};
