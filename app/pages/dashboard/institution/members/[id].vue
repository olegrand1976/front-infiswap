<template>
    <div>
        ...
        <DashboardAdminPageContent class="bg-gray-50/50 p-6 rounded-xl">
            <div v-if="loadingMember" class="flex flex-col gap-4 justify-center items-center py-24 text-center">
                <div class="w-12 h-12 border-4 border-primary border-t-transparent rounded-full animate-spin"></div>
                <p class="text-muted-foreground animate-pulse text-lg font-medium italic">Chargement des données...</p>
            </div>
                    ...
                    <div class="col-span-3 lg:col-span-2 bg-white p-6 rounded-xl border shadow-sm flex flex-col gap-6">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                disabled
                            />
                            <p class="text-xs text-muted-foreground italic">L'adresse e-mail ne peut pas être modifiée.</p>
                        </div>
