    ...
    <div>
        <div class="hidden sm:flex flex-row h-screen overflow-hidden">
            <BackButton
                ...
                class="text-white"
            />
            <div class="w-1/2 bg-primary/90 py-14 overflow-hidden flex flex-col">
                <h1 class="mb-6 text-sm max-w-xl mx-auto mt-8 xl:text-base text-center">
                ...
                <div class="rounded-2xl p-8 max-w-md mx-auto">
                    <LayoutsAppImage
            ...
            <div class="w-1/2 bg-white overflow-y-auto overflow-x-hidden flex flex-col items-center relative py-14">
                ...
                <div class="w-full max-w-5xl px-8 font-light">
                    ...
                    >
                        <div>
                            <h2 class="mt-1 text-md font-semibold text-gray-800 mb-2">
                                Type de compte
                            </h2>
                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm  mb-4">
