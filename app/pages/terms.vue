...
const terms = {
    ...
    proSubscription: {
        title: 'Abonnement Infiswap Pro',
        text: `<p>L’usage du réseau InfiSwap (recherche, publication, candidature, messagerie) demeure gratuit. L’abonnement « Infiswap Pro » est facultatif et ouvre trois avantages : alerte instantanée à la publication d’un remplacement, un boost de mise en avant de 7 jours offert par mois calendaire, et les contrats de remplacement inclus en nombre illimité.</p>
        <p class="mt-2"><strong>Formules et durées.</strong> Les tarifs sont exprimés toutes taxes comprises et correspondent à un nombre de mois facturés au tarif mensuel de référence en vigueur : 1 mois facturé pour la formule mensuelle, 10 mois pour la formule annuelle, 18 mois pour la formule de 2 ans, 24 mois pour la formule de 3 ans. Les formules de 2 et 3 ans sont réservées au canal de vente téléphonique et proposées nominativement.</p>
