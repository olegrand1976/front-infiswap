...
const terms = {
    ...
    proSubscription: {
        ...
        text: `<p>L’usage du réseau InfiSwap (recherche, publication, candidature, messagerie) demeure gratuit. L’abonnement « Infiswap Premium » est facultatif et ouvre quatre avantages : alerte instantanée à la publication d’un remplacement, un boost de mise en avant de 7 jours offert par mois calendaire, les contrats de remplacement inclus en nombre illimité, et la mise en valeur du compte (étoile jaune « Membre premium » sur les annonces et candidatures).</p>
