<template>
    <footer>
                    ...
                    <div class="flex flex-col w-full space-y-4 py-8 md:py-0 text-center">
                        ...
                        >
                            <div class="flex flex-row justify-start items-center">
                                <Mail class="text-info w-4 h-4 ms-3" />
                                <Input
                                    v-model="email"
                                    placeholder="Email"
                                    class="w-full text-info text-sm"
                                />
                            </div>
                            <Button
                                :disabled="isLoading"
                                variant="secondary"
                                class="text-white h-8 bg-info"
                                type="submit"
                            >
                        ...
                        <div class="lg:p-6 flex flex-col items-center text-center h-full justify-center">
                            <div class="max-w-md mx-auto">
                                ...
                                <div class="flex flex-col items-center gap-4">
                                    <Button
                                        class="bg-info hover:bg-info/90 text-white font-semibold py-2 px-4 rounded-full w-full transition w-[300px]"
                                        href="/register"
                                    >
                                        Inscription
                                    </Button>
        ...
        <div class="bg-info text-white py-4 md:px-0 px-8 lg:-mt-6">
            <p
        ...
        <div class="container py-4 w-full text-center text-info">
            <NuxtLink
