<template>
    <NuxtLayout name="guest">
        ...
        <div class="relative">
            <div class="absolute inset-0 bg-tertiary/30 h-[300px] lg:h-full w-full"></div>
            <div class="container">
            ...
            <div class="absolute bottom-0 right-0 hidden lg:block z-0">
                <NuxtImg src="/Vector_2.png" class="w-64 lg:w-[32rem] relative"/>
            </div>
            <div class="absolute bottom-[20%] left-2 hidden lg:block z-0">
                <NuxtImg src="/icons/Unin.png" class="w-8 lg:w-12 relative"/>
            </div>
        </div>
