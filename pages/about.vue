<template>
    <NuxtLayout name="guest">
        ...
        <div class="relative">
            <!-- Background uniquement sur desktop avec hauteur ajustée sur mobile -->
            <div class="absolute inset-0 bg-tertiary/30 h-[200px] lg:h-full w-full"></div>
            <div class="relative my-8 lg:my-16 z-20 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-44 items-center p-8 lg:p-20">
                ...
                <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
                    <NuxtImg
                        ...
                        class="w-full max-w-xs lg:max-w-none z-20"
                    />
                </div>
                <div class="absolute bottom-0 right-0 hidden lg:block">
                    <NuxtImg src="/Vector_2.png" class="w-64 lg:w-[32rem] -z-10 relative"/>
                </div>
                <div class="absolute bottom-[20%] left-2 hidden lg:block">
                    <NuxtImg src="/icons/Unin.png" class="w-8 lg:w-12 -z-10 relative"/>
                </div>
            </div>
        </div>
