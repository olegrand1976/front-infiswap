<template>
    <div class="pt-28 pb-20 sm:py-20">
        <div class="bg-white sm:bg-tertiary/30 sm:h-80 flex justify-center items-center relative">
        ...
        <Form class="pt-8 sm:pt-24 container flex flex-col space-y-5 sm:w-[70%] lg:w-[55%]">
            <FormField name="nom">
