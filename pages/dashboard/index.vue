      ...
      <div class="flex flex-col space-y-4">
        <div class="bg-gray-100 rounded p-4">
          ...
          <form class="mt-6 space-y-4">
            <div
              class="grid grid-cols-[40%_60%] border border-primary h-9 rounded-full"
            >
              <div
                class="bg-primary w-64 flex items-center text-white ps-4 rounded-s-full"
              >
                ...
                <div v-for="(tournee, index) in reports.tours" :key="index">
                  ...
                  >
                    <TableCell class="bg-gray-100">
                      <div
                        class="flex h-10 rounded mt-3 bg-gray-200 justify-center items-center"
                      >
              ...
              <template v-else>
                ...
                <p>
                  ...
                  <Button
                    ...
                    disabled
                  >
                    Enregistrer votre tournée sur InfiSwap pour bénéficier de
