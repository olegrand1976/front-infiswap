    ...
    return [
        {
            ...
            items: [
                ...
                {
                    value: reports.value.registration_statistics.this_week + reports.value.registration_statistics.last_week,
                    label: 'Cette semaine / Dernière',
        ...
        },
        {
            ...
            items: [
                ...
                {
                    value: reports.value.patient_by_nurse_statistics.this_week + reports.value.patient_by_nurse_statistics.last_week,
                    label: 'Cette semaine / Dernière',
                    colorClass: 'bg-orange-700',
                    icon: HeartIcon,
                    containerClass: 'string',
        ...
        },
        {
            ...
            items: [
                ...
                {
                    value: reports.value.tour_statistics.this_week + reports.value.tour_statistics.last_week,
                    label: 'Cette semaine / Dernière',
                    colorClass: 'bg-orange-700',
                    icon: MapPinIcon,
                    containerClass: 'string',
        ...
        },
        {
            ...
            items: [
                ...
                {
                    value: reports.value.accepted_replacement_statistics.this_week + reports.value.accepted_replacement_statistics.last_week,
                    label: 'Cette semaine / Dernière',
                    colorClass: 'bg-orange-700',
                    icon: ArrowPathIcon,
                    containerClass: 'string',
        ...
        },
        {
            ...
            items: [
                ...
                {
                    value: reports.value.replacement_response_statistics.this_week + reports.value.replacement_response_statistics.last_week,
                    label: 'Cette semaine / Dernière',
                    colorClass: 'bg-orange-700',
                    icon: PaperAirplaneIcon,
                    containerClass: 'string',
